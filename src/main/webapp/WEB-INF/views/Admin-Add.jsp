...
<div class="page-container">
    <div action="" method="post" class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">职工名：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="" id="uUsername" placeholder="" value="" class="input-text" style="width:90%">
            </div>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">职工密码：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="" id="uPassword" placeholder="" value="" class="input-text" style="width:90%">
            </div>
        </div>


        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">职工权限：</label>
...
<script type="text/javascript">
    ...
    function sub() {
        ...
        var ChangeAdminLimit = $("#ChangeAdminLimit option:selected").val();//获取选中的项
        //layui关闭弹出层
        ...
        $.ajax({
            ...
            data: {
                'uUsername': uUsername,
                'uPassword' : uPassword,
                'ChangeAdminLimit': ChangeAdminLimit,
            },
