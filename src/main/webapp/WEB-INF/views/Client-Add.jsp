...
<div class="page-container">
    <div action="" method="post" class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">客户名：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="" id="cClientname" placeholder="" value="" class="input-text" style="width:90%">
            </div>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">客户密码：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="" id="cPassword" placeholder="" value="" class="input-text" style="width:90%">
            </div>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">客户电话号码：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="" id="cPhonenum" placeholder="" value="" class="input-text" style="width:90%">
            </div>
        </div>
